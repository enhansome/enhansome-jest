...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,020 | 🐛 392 | 🌐 JavaScript | 📅 2026-08-28 Jest matcher for testing Emotion components.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,958 | 🐛 1,774 | 🌐 TypeScript | 📅 2026-08-28 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,020 | 🐛 392 | 🌐 JavaScript | 📅 2026-08-28 Include Emotion styles in component snapshots.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,121 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-29 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,516 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-28.
