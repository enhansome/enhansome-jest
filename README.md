...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-14 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,538 | 🐛 434 | 🌐 HTML | 📅 2026-09-21 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,155 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-21 Snapshot serializer for ANSI escape sequences.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,150 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-20 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,606 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-21.
* [testdouble-jest](https://github.com/testdouble/testdouble-jest) ⭐ 37 | 🐛 3 | 🌐 JavaScript | 📅 2021-06-02 Support for [testdouble.js](https://github.com/testdouble/testdouble.js) ⭐ 1,425 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-21 for users of Jest.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,072 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-21 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-20 Jest preset for [Angular](https://angular.io) projects.
