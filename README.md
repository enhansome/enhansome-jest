...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,019 | 🐛 394 | 🌐 JavaScript | 📅 2026-08-28 Jest matcher for testing Emotion components.
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,597 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
* [expect-puppeteer](https://github.com/smooth-code/jest-puppeteer/tree/master/packages/expect-puppeteer) ⭐ 3,545 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-26 Collection of matchers for Jest & Puppeteer.
* [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-07 Adds additional matchers to core API making it easy to test everything.
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-09 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,492 | 🐛 441 | 🌐 JavaScript | 📅 2026-09-09 for testing accessibility.
...
* [@testing-library/jest-native](https://github.com/testing-library/jest-native) ⭐ 437 | 🐛 7 | 🌐 TypeScript | 📅 2025-03-05 Jest matchers to test the state of React Native.
...
* [jest-json-schema](https://github.com/americanexpress/jest-json-schema) ⭐ 172 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-03 JSON schema matcher.
...
* [wallaby](https://github.com/wallabyjs/public) ⭐ 775 | 🐛 151 | 📅 2026-09-01 The pinnacle of the idea of a test runner integrated into an editor.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,163 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-08.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,170 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-07 ESLint plugin for Jest.
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-03 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,597 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-09.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 22 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-07 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-07.

### Runners

* [jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint) ⭐ 480 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-09 ESLint runner for Jest.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-08 Prettier runner for Jest.
* [jest-runner-tsd](https://github.com/jest-community/jest-runner-tsd) ⭐ 77 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-09 Runner for running TypeScript type tests.
...
* [jest-html-reporters](https://github.com/Hazyzh/jest-html-reporters) ⭐ 541 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-07 A Jest test results processor for generating a summary in HTML.
* [jest-junit](https://github.com/jest-community/jest-junit) ⭐ 502 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-07 A JUnit format reporter for Jest which can integrate with CI systems.
* [jest-html-reporter](https://github.com/Hargne/jest-html-reporter) ⭐ 287 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 A Jest test results processor for generating a summary in HTML.
* [jest-stare](https://github.com/dkelosky/jest-stare) ⭐ 269 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-01 Configurable HTML reporter for filtering, side-by-side snapshot diffs, API, and simple CLI.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 152 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [jest-github-reporter](https://github.com/hipstersmoothie/jest-github-reporter) ⭐ 106 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-09 Report jest test errors directly in pull requests.
...
* [jest-standard-reporter](https://github.com/chrisgalvan/jest-standard-reporter) ⭐ 22 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-07 Reporter that uses stdout for messages and stderr for errors.
...
* [jest-simple-dot-reporter](https://github.com/jodonnell/jest-simple-dot-reporter) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2023-01-06 A simple dot reporter - one dot per each test.
...
* [jest-ado-reporter](https://github.com/bashaus/jest-ado-reporter) ⭐ 3 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-01 Reports jest test suite progress information to the pipeline step in Azure DevOps.
...
* [majestic](https://github.com/Raathigesh/majestic) ⭐ 7,448 | 🐛 50 | 🌐 TypeScript | 📅 2022-05-03 Zero config UI for Jest.

### Environments

* [jest-environment-puppeteer](https://github.com/smooth-code/jest-puppeteer/tree/master/packages/jest-environment-puppeteer) ⭐ 3,545 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-26 Puppeteer environment for Jest.
...
* [jest-doctor](https://github.com/stephan-dum/jest-doctor/tree/main/packages/jest-doctor) ⭐ 11 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 Async leak detection and preventions.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 91,028 | 🐛 1,820 | 🌐 TypeScript | 📅 2026-09-09 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,019 | 🐛 394 | 🌐 JavaScript | 📅 2026-08-28 Include Emotion styles in component snapshots.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-08 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 Snapshot serializer for ANSI escape sequences.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 887 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-07 Makes it easy to migrate from other test runner and frameworks to Jest.
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,142 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-09 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,559 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09.
* [testdouble-jest](https://github.com/testdouble/testdouble-jest) ⭐ 37 | 🐛 3 | 🌐 JavaScript | 📅 2021-06-02 Support for [testdouble.js](https://github.com/testdouble/testdouble.js) ⭐ 1,426 | 🐛 35 | 🌐 JavaScript | 📅 2024-03-21 for users of Jest.
...
* [jest-fetch-mock](https://github.com/jefflau/jest-fetch-mock) ⭐ 894 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-07 Easily mock out `fetch` and set up responses, powered by [Jest mock functions](https://facebook.github.io/jest/docs/en/mock-functions.html).
...
* [jest-watch-typeahead](https://github.com/jest-community/jest-watch-typeahead) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-09 Filter your tests by file name or test name.
...
* [jest-watch-suspend](https://github.com/unional/jest-watch-suspend) ⭐ 16 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-09 Suspend watch mode so that your changes would not trigger test runs.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-08 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,074 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-09 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 750 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-07 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-puppeteer](https://github.com/smooth-code/jest-puppeteer) ⭐ 3,545 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-26 A Jest preset that enables a ready-to-use environment to write integration tests using Puppeteer.
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-09 Jest preset for [Angular](https://angular.io) projects.
...
* [jest-preview](https://github.com/nvh95/jest-preview) ⭐ 2,392 | 🐛 50 | 🌐 TypeScript | 📅 2026-04-25 Preview Jest tests in a browser.
