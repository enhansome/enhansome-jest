...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,018 | 🐛 392 | 🌐 JavaScript | 📅 2026-08-26 Jest matcher for testing Emotion components.
...
* [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-26 Adds additional matchers to core API making it easy to test everything.
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-10 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,447 | 🐛 431 | 🌐 JavaScript | 📅 2026-08-27 for testing accessibility.
...
* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,170 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 ESLint plugin for Jest.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 22 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-26 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 121 | 🌐 TypeScript | 📅 2026-08-26.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,948 | 🐛 1,773 | 🌐 TypeScript | 📅 2026-08-27 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,018 | 🐛 392 | 🌐 JavaScript | 📅 2026-08-26 Include Emotion styles in component snapshots.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 888 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-26 Makes it easy to migrate from other test runner and frameworks to Jest.
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-26 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,119 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-27 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,506 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-26.
...
* [Suites](https://github.com/suites-dev/suites) ⭐ 545 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-26 Unit-testing framework for TypeScript backends with inversion of control and dependency injection that automatically generates type-safe mocks.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,075 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-26 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-27 Jest preset for [Angular](https://angular.io) projects.
