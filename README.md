...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-09 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,501 | 🐛 449 | 🌐 JavaScript | 📅 2026-09-11 for testing accessibility.
...
* [jest-fetch-mock](https://github.com/jefflau/jest-fetch-mock) ⭐ 894 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-11 Easily mock out `fetch` and set up responses, powered by [Jest mock functions](https://facebook.github.io/jest/docs/en/mock-functions.html).
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,073 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-11 TypeScript preprocessor with sourcemap support.
