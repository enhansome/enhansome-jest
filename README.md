...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,017 | 🐛 389 | 🌐 JavaScript | 📅 2026-05-06 Jest matcher for testing Emotion components.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,112 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-10 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,431 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-21 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,171 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-23.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,170 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-17 ESLint plugin for Jest.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,907 | 🐛 1,793 | 🌐 TypeScript | 📅 2026-08-22 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,017 | 🐛 389 | 🌐 JavaScript | 📅 2026-05-06 Include Emotion styles in component snapshots.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-22 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 796 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-23 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,115 | 🐛 77 | 🌐 TypeScript | 📅 2026-08-23 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,490 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-23.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,075 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-23 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-23 Jest preset for [Angular](https://angular.io) projects.
* [jest-mongodb](https://github.com/shelfio/jest-mongodb) ⭐ 602 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-22 Jest preset for working with MongoDB.
* [jest-dynamodb](https://github.com/shelfio/jest-dynamodb) ⭐ 198 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-22 Jest preset for working with DynamoDB.
