...
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,597 | 🐛 150 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
...
* [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-24 Adds additional matchers to core API making it easy to test everything.
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-23 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,557 | 🐛 446 | 🌐 HTML | 📅 2026-09-23 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,156 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,174 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-24 ESLint plugin for Jest.
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,597 | 🐛 150 | 🌐 JavaScript | 📅 2026-08-09.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 23 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-24 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-24.

### Runners

* [jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint) ⭐ 479 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-24 ESLint runner for Jest.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25 Prettier runner for Jest.
* [jest-runner-tsd](https://github.com/jest-community/jest-runner-tsd) ⭐ 77 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-25 Runner for running TypeScript type tests.
...
* [jest-github-reporter](https://github.com/hipstersmoothie/jest-github-reporter) ⭐ 106 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-25 Report jest test errors directly in pull requests.
...
* [jest-standard-reporter](https://github.com/chrisgalvan/jest-standard-reporter) ⭐ 22 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-25 Reporter that uses stdout for messages and stderr for errors.
...
* [jest-doctor](https://github.com/stephan-dum/jest-doctor/tree/main/packages/jest-doctor) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 Async leak detection and preventions.
* [jest-environment-webgl-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgl-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 Headless WebGL 1/2 environment for Jest, backed by ANGLE.
* [jest-environment-webgpu-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgpu-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 Headless WebGPU environment for Jest, backed by Dawn.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-25 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 887 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-24 Makes it easy to migrate from other test runner and frameworks to Jest.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,155 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-25 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,621 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-25.
...
* [jest-watch-typeahead](https://github.com/jest-community/jest-watch-typeahead) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-25 Filter your tests by file name or test name.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,071 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-25 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 750 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-24 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-25 Jest preset for [Angular](https://angular.io) projects.
