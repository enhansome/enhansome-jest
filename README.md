...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,015 | 🐛 388 | 🌐 JavaScript | 📅 2026-05-06 Jest matcher for testing Emotion components.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,112 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-10 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,412 | 🐛 441 | 🌐 JavaScript | 📅 2026-08-18 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,174 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-19.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,875 | 🐛 1,771 | 🌐 TypeScript | 📅 2026-08-19 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,015 | 🐛 388 | 🌐 JavaScript | 📅 2026-05-06 Include Emotion styles in component snapshots.
...
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,106 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-19 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,465 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-19.
...
* [Suites](https://github.com/suites-dev/suites) ⭐ 545 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-17 Unit-testing framework for TypeScript backends with inversion of control and dependency injection that automatically generates type-safe mocks.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-18 Repeat test runs multiple times.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-19 Jest preset for [Angular](https://angular.io) projects.
* [jest-mongodb](https://github.com/shelfio/jest-mongodb) ⭐ 602 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-17 Jest preset for working with MongoDB.
* [jest-dynamodb](https://github.com/shelfio/jest-dynamodb) ⭐ 198 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-19 Jest preset for working with DynamoDB.
