...
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,471 | 🐛 438 | 🌐 JavaScript | 📅 2026-09-03 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,170 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03.
...
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-03 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 143 | 🌐 JavaScript | 📅 2026-08-09.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 22 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-02 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-02.

### Runners

* [jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint) ⭐ 480 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-03 ESLint runner for Jest.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-02 Prettier runner for Jest.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 151 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-03 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [jest-standard-reporter](https://github.com/chrisgalvan/jest-standard-reporter) ⭐ 22 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-02 Reporter that uses stdout for messages and stderr for errors.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,995 | 🐛 1,796 | 🌐 TypeScript | 📅 2026-09-03 StoryShots adds automatic Jest Snapshot Testing for Storybook.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-02 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-31 Snapshot serializer for ANSI escape sequences.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 888 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-03 Makes it easy to migrate from other test runner and frameworks to Jest.
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-03 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,132 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-03 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,537 | 🐛 256 | 🌐 TypeScript | 📅 2026-09-03.
...
* [jest-watch-typeahead](https://github.com/jest-community/jest-watch-typeahead) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-02 Filter your tests by file name or test name.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,075 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-03 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 751 | 🐛 138 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-03 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-03 Jest preset for [Angular](https://angular.io) projects.
