...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-13 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,505 | 🐛 449 | 🌐 JavaScript | 📅 2026-09-11 for testing accessibility.
...
* [wallaby](https://github.com/wallabyjs/public) ⭐ 775 | 🐛 152 | 📅 2026-09-01 The pinnacle of the idea of a test runner integrated into an editor.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,161 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-11.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 91,049 | 🐛 1,827 | 🌐 TypeScript | 📅 2026-09-12 StoryShots adds automatic Jest Snapshot Testing for Storybook.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,145 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-13 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,580 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-13.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,073 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-13 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-13 Jest preset for [Angular](https://angular.io) projects.
