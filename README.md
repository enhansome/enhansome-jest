...
* [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-26 Adds additional matchers to core API making it easy to test everything.
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-23 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,559 | 🐛 447 | 🌐 HTML | 📅 2026-09-23 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,154 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-26.
...
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 370 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,597 | 🐛 150 | 🌐 JavaScript | 📅 2026-08-09.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 23 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-24 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 124 | 🌐 TypeScript | 📅 2026-09-26.
...
* [majestic](https://github.com/Raathigesh/majestic) ⭐ 7,446 | 🐛 51 | 🌐 TypeScript | 📅 2022-05-03 Zero config UI for Jest.
...
* [jest-environment-webgl-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgl-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-26 Headless WebGL 1/2 environment for Jest, backed by ANGLE.
* [jest-environment-webgpu-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgpu-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-26 Headless WebGPU environment for Jest, backed by Dawn.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 887 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-26 Makes it easy to migrate from other test runner and frameworks to Jest.
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-26 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,159 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-26 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,622 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-25.
...
* [jest-watch-suspend](https://github.com/unional/jest-watch-suspend) ⭐ 16 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 Suspend watch mode so that your changes would not trigger test runs.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-26 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,071 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-26 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-26 Jest preset for [Angular](https://angular.io) projects.
