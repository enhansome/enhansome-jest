...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-14 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,514 | 🐛 439 | 🌐 HTML | 📅 2026-09-16 for testing accessibility.
...
* [vscode-jest-runner](https://github.com/firsttris/vscode-jest-runner) ⭐ 302 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-10 Simple way to run or debug one or more tests from context menu, codelens or command plalette.
* [jester](https://github.com/David-Kunz/jester) ⭐ 213 | 🐛 4 | 🌐 Lua | 📅 2025-01-15 A Neovim plugin to easily run and debug Jest tests.
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,155 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-16.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,171 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-15 ESLint plugin for Jest.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 152 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-11 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 91,076 | 🐛 1,854 | 🌐 TypeScript | 📅 2026-09-16 StoryShots adds automatic Jest Snapshot Testing for Storybook.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-15 Snapshot serializer for ANSI escape sequences.
...
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,144 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-16 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,585 | 🐛 260 | 🌐 TypeScript | 📅 2026-09-16.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,074 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-16 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 749 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-16 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-16 Jest preset for [Angular](https://angular.io) projects.
