...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-14 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,508 | 🐛 445 | 🌐 JavaScript | 📅 2026-09-14 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,161 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-11.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,170 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-14 ESLint plugin for Jest.
...
* [jest-light-runner](https://github.com/nicolo-ribaudo/jest-light-runner) ⭐ 242 | 🐛 21 | 🌐 JavaScript | 📅 2026-07-31 Runner that runs tests directly in bare Node.js, without virtualizing the environment.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-10 Prettier runner for Jest.
...
* [jest-github-reporter](https://github.com/hipstersmoothie/jest-github-reporter) ⭐ 106 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-10 Report jest test errors directly in pull requests.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 91,053 | 🐛 1,830 | 🌐 TypeScript | 📅 2026-09-14 StoryShots adds automatic Jest Snapshot Testing for Storybook.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-11 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 Snapshot serializer for ANSI escape sequences.
...
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-13 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,146 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-14 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,578 | 🐛 258 | 🌐 TypeScript | 📅 2026-09-14.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-14 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,074 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-14 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 749 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-10 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-14 Jest preset for [Angular](https://angular.io) projects.
