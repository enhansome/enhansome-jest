...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,016 | 🐛 386 | 🌐 JavaScript | 📅 2026-05-06 Jest matcher for testing Emotion components.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,112 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-10 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,401 | 🐛 433 | 🌐 JavaScript | 📅 2026-08-13 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,172 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-14.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 22 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-13 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,350 | 🐛 125 | 🌐 TypeScript | 📅 2026-08-13.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 151 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-14 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 90,852 | 🐛 1,773 | 🌐 TypeScript | 📅 2026-08-14 StoryShots adds automatic Jest Snapshot Testing for Storybook.
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,016 | 🐛 386 | 🌐 JavaScript | 📅 2026-05-06 Include Emotion styles in component snapshots.
...
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 797 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-14 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,098 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-14 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,462 | 🐛 260 | 🌐 TypeScript | 📅 2026-08-14.
...
* [Suites](https://github.com/suites-dev/suites) ⭐ 544 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-14 Unit-testing framework for TypeScript backends with inversion of control and dependency injection that automatically generates type-safe mocks.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,076 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-13 TypeScript preprocessor with sourcemap support.
...
* [jest-dynamodb](https://github.com/shelfio/jest-dynamodb) ⭐ 198 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-14 Jest preset for working with DynamoDB.
