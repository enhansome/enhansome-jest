...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,019 | 🐛 395 | 🌐 JavaScript | 📅 2026-08-28 Jest matcher for testing Emotion components.
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
...
* [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-21 Adds additional matchers to core API making it easy to test everything.
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-23 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,554 | 🐛 442 | 🌐 HTML | 📅 2026-09-23 for testing accessibility.
...
* [jest-json-schema](https://github.com/americanexpress/jest-json-schema) ⭐ 172 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-10 JSON schema matcher.
...
* [vscode-jest-runner](https://github.com/firsttris/vscode-jest-runner) ⭐ 303 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-10 Simple way to run or debug one or more tests from context menu, codelens or command plalette.
* [jester](https://github.com/David-Kunz/jester) ⭐ 213 | 🐛 4 | 🌐 Lua | 📅 2025-01-15 A Neovim plugin to easily run and debug Jest tests.
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,155 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22.

### Linting

* [eslint-plugin-jest](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,174 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-21 ESLint plugin for Jest.
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 149 | 🌐 JavaScript | 📅 2026-08-09.
...
* [eslint-plugin-jest-extended](https://github.com/jest-community/eslint-plugin-jest-extended) ⭐ 23 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-19 ESLint plugin for [jest-extended](https://github.com/jest-community/jest-extended) ⭐ 2,349 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-21.

### Runners

* [jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint) ⭐ 479 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-18 ESLint runner for Jest.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-24 Prettier runner for Jest.
* [jest-runner-tsd](https://github.com/jest-community/jest-runner-tsd) ⭐ 77 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-21 Runner for running TypeScript type tests.
...
* [jest-html-reporters](https://github.com/Hazyzh/jest-html-reporters) ⭐ 541 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-10 A Jest test results processor for generating a summary in HTML.
* [jest-junit](https://github.com/jest-community/jest-junit) ⭐ 502 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-18 A JUnit format reporter for Jest which can integrate with CI systems.
...
* [jest-stare](https://github.com/dkelosky/jest-stare) ⭐ 269 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-24 Configurable HTML reporter for filtering, side-by-side snapshot diffs, API, and simple CLI.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 152 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-23 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [jest-github-reporter](https://github.com/hipstersmoothie/jest-github-reporter) ⭐ 106 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-21 Report jest test errors directly in pull requests.
...
* [jest-standard-reporter](https://github.com/chrisgalvan/jest-standard-reporter) ⭐ 22 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-18 Reporter that uses stdout for messages and stderr for errors.
...
* [jest-ado-reporter](https://github.com/bashaus/jest-ado-reporter) ⭐ 3 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-21 Reports jest test suite progress information to the pipeline step in Azure DevOps.
...
* [majestic](https://github.com/Raathigesh/majestic) ⭐ 7,446 | 🐛 50 | 🌐 TypeScript | 📅 2022-05-03 Zero config UI for Jest.
...
* [jest-doctor](https://github.com/stephan-dum/jest-doctor/tree/main/packages/jest-doctor) ⭐ 11 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 Async leak detection and preventions.
* [jest-environment-webgl-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgl-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 Headless WebGL 1/2 environment for Jest, backed by ANGLE.
* [jest-environment-webgpu-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgpu-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 Headless WebGPU environment for Jest, backed by Dawn.
...
* [@emotion/jest](https://github.com/emotion-js/emotion/tree/main/packages/jest) ⭐ 18,019 | 🐛 395 | 🌐 JavaScript | 📅 2026-08-28 Include Emotion styles in component snapshots.
* [jest-image-snapshot](https://github.com/americanexpress/jest-image-snapshot) ⭐ 3,916 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-05 Take a snapshot test of an image buffer, and catch when the image changes over a threshold. Commonly used for visual regression testing.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-24 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-serializer-ansi-escapes](https://github.com/mrazauskas/jest-serializer-ansi-escapes) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-22 Snapshot serializer for ANSI escape sequences.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 887 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-24 Makes it easy to migrate from other test runner and frameworks to Jest.
* [@putout/plugin-jest](https://github.com/coderaiser/putout/blob/master/packages/plugin-jest/README.md#putoutplugin-jest-) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 🐊Putout plugin helps to migrate to latest Jest API.

### Library extensions

* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,155 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-24 Bring property based testing (aka fuzzing) into Jest.
...
* [@testdeck/jest](https://github.com/testdeck/testdeck) ⭐ 235 | 🐛 7 | 🌐 TypeScript | 📅 2025-01-22 Decorator based wrapper around Jest for object oriented testing. Checkout the [documentation](https://testdeck.github.io/docs/) and a working [seed](https://github.com/testdeck/testdeck-jest-seed) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2020-11-19 for you to start with.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,620 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-24.
* [testdouble-jest](https://github.com/testdouble/testdouble-jest) ⭐ 37 | 🐛 3 | 🌐 JavaScript | 📅 2021-06-02 Support for [testdouble.js](https://github.com/testdouble/testdouble.js) ⭐ 1,425 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-21 for users of Jest.
...
* [jest-watch-typeahead](https://github.com/jest-community/jest-watch-typeahead) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-18 Filter your tests by file name or test name.
...
* [jest-watch-suspend](https://github.com/unional/jest-watch-suspend) ⭐ 16 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 Suspend watch mode so that your changes would not trigger test runs.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,072 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-24 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 750 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-23 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-24 Jest preset for [Angular](https://angular.io) projects.
