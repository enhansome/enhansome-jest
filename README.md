...
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 147 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-23 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,549 | 🐛 438 | 🌐 HTML | 📅 2026-09-23 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,154 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-22.
...
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,596 | 🐛 147 | 🌐 JavaScript | 📅 2026-08-09.
...
* [jest-stare](https://github.com/dkelosky/jest-stare) ⭐ 269 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-21 Configurable HTML reporter for filtering, side-by-side snapshot diffs, API, and simple CLI.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 152 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-23 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [jest-environment-webgl-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgl-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 Headless WebGL 1/2 environment for Jest, backed by ANGLE.
* [jest-environment-webgpu-node](https://github.com/bhouston/jest-gpu/tree/main/packages/jest-environment-webgpu-node) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 Headless WebGPU environment for Jest, backed by Dawn.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,153 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-23 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,616 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-23.
...
* [jest-watch-suspend](https://github.com/unional/jest-watch-suspend) ⭐ 16 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-22 Suspend watch mode so that your changes would not trigger test runs.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-22 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,072 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-23 TypeScript preprocessor with sourcemap support.
...
* [jest-preset-angular](https://github.com/thymikee/jest-preset-angular) ⭐ 920 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-23 Jest preset for [Angular](https://angular.io) projects.
