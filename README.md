...
* [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,598 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-09 Jest matchers to test the state of the DOM.
...
* [jest-axe](https://github.com/nickcolley/jest-axe) ⭐ 1,111 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-09 Jest matcher for [axe](https://github.com/dequelabs/axe-core) ⭐ 7,495 | 🐛 445 | 🌐 JavaScript | 📅 2026-09-10 for testing accessibility.
...
* [coc-jest](https://github.com/neoclide/coc-jest) ⭐ 51 | 🐛 4 | 🌐 TypeScript | 📅 2025-04-19 Jest plugin for [coc.nvim](https://github.com/neoclide/coc.nvim) ⭐ 25,163 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10.
...
* [eslint-plugin-jest-dom](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 369 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-03 ESLint plugin to follow best practices and anticipate common mistakes when writing tests with [@testing-library/jest-dom](https://github.com/testing-library/jest-dom) ⭐ 4,598 | 🐛 145 | 🌐 JavaScript | 📅 2026-08-09.
...
* [jest-runner-eslint](https://github.com/jest-community/jest-runner-eslint) ⭐ 479 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-09 ESLint runner for Jest.
...
* [jest-runner-prettier](https://github.com/keplersj/jest-runner-prettier) ⭐ 91 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-09 Prettier runner for Jest.
* [jest-runner-tsd](https://github.com/jest-community/jest-runner-tsd) ⭐ 77 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-10 Runner for running TypeScript type tests.
...
* [jest-junit](https://github.com/jest-community/jest-junit) ⭐ 502 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-10 A JUnit format reporter for Jest which can integrate with CI systems.
...
* [testomatio-jest-reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Jest) ⭐ 152 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-10 Allows to analyze Jest autotests, collect test metadata and report them to the testomat.io TCM system.
...
* [jest-standard-reporter](https://github.com/chrisgalvan/jest-standard-reporter) ⭐ 22 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-09 Reporter that uses stdout for messages and stderr for errors.
...
* [majestic](https://github.com/Raathigesh/majestic) ⭐ 7,447 | 🐛 50 | 🌐 TypeScript | 📅 2022-05-03 Zero config UI for Jest.
...
* [StoryShots](https://github.com/storybooks/storybook/tree/master/addons/storyshots/storyshots-core) ⭐ 91,034 | 🐛 1,821 | 🌐 TypeScript | 📅 2026-09-10 StoryShots adds automatic Jest Snapshot Testing for Storybook.
...
* [snapshot-diff](https://github.com/jest-community/snapshot-diff) ⭐ 604 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-10 Takes two values, and return their difference as a string, ready to be snapshotted with `toMatchSnapshot()`. Especially helpful when testing the difference between different React component states.
...
* [jest-codemods](https://github.com/skovhus/jest-codemods) ⭐ 887 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-09 Makes it easy to migrate from other test runner and frameworks to Jest.
...
* [@fast-check/jest](https://github.com/dubzzz/fast-check/tree/main/packages/jest) ⭐ 5,144 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-09 Bring property based testing (aka fuzzing) into Jest.
...
* [jest-puppe-shots](https://github.com/macku/jest-puppe-shots) ⭐ 84 | 🐛 2 | 🌐 JavaScript | 📅 2020-01-05 A Jest plugin for creating screenshots of [React](https://reactjs.org) components with a little help of [Puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,568 | 🐛 257 | 🌐 TypeScript | 📅 2026-09-09.
...
* [jest-location-mock](https://github.com/evelynhathaway/jest-location-mock) ⭐ 63 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-17 Mock `window.location` easily.
...
* [jest-watch-typeahead](https://github.com/jest-community/jest-watch-typeahead) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-10 Filter your tests by file name or test name.
...
* [jest-watch-repeat](https://github.com/unional/jest-watch-repeat) ⭐ 5 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 Repeat test runs multiple times.
...
* [ts-jest](https://github.com/kulshekhar/ts-jest) ⭐ 7,073 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-09 TypeScript preprocessor with sourcemap support.
* [vue-jest](https://github.com/vuejs/vue-jest) ⭐ 749 | 🐛 140 | 🌐 JavaScript | 📅 2024-01-29 Vue transformer with source map support.
* [jest-raw-loader](https://github.com/keplersj/jest-raw-loader) ⭐ 34 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-10 Processor mimicking `webpack`'s `raw-loader`.
...
* [jest-preview](https://github.com/nvh95/jest-preview) ⭐ 2,391 | 🐛 50 | 🌐 TypeScript | 📅 2026-04-25 Preview Jest tests in a browser.
